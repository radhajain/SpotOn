...
export declare class RadCalendar extends commonModule.RadCalendar {
    ...
    static dateWithoutHours(originalDate: Date): Date;
    reload(): void;
...
export declare class CalendarNativeDataSourceImplementation extends NSObject implements TKCalendarDataSource {
    ...
    calendarEventsFromDateToDateWithCallback(calendar: TKCalendar, fromDate: Date, toDate: Date, callback: (NSArray) => void): NSArray<any>;
}
...
export declare class TKCalendarNativeDelegateImplementation extends NSObject implements TKCalendarDelegate {
    ...
    private applyWeekViewCellStyles(cell);
    private applyDayViewCellStyles(cell);
    private applyYearViewCellStyles(cell);
    private applyMonthNamesViewCellStyles(cell);
    private applyMonthViewCellStyles(cell);
    /**
     * Generic method that applies regular day style to cell of given view mode
     */
    private applyDayCellStyleToCell(viewModeStyle, cell);
    private applyTitleCellStyleToCell(viewModeStyle, cell);
    private applyDayNameCellStyleToCell(viewModeStyle, cell);
    private applyMonthNameCellStyleToCell(viewModeStyle, cell);
    private applyWeekNumberCellStyleToCell(viewModeStyle, cell);
    private applyCommonCellStyleProperties(cell, cellStyle);
    private getViewModeFromTKCalendarViewMode(viewMode);
}
